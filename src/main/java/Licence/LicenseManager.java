...
/**
 * This is the main workhorse for the licensing code. It generates the keys and
 * checks them.
 *
 * @author fabrice
 */
...
public class LicenseManager {
    ...
    public static KeyStatus readLicenseFile(String licensePath, String signaturePath, String hashPath) {
        try {
            ...
            if (LICENSE.getLicenseType().equals(TypeLicense.TRIAL)) {
                IS_TRIAL = true;
            ...
            } else if (LICENSE.getLicenseType().equals(TypeLicense.SINGLE_VERSION)) {
                IS_TRIAL = false;
                status = checkKey(lic);
                IS_LICENSED = true;
            } else if (LICENSE.getLicenseType().equals(TypeLicense.LIFETIME)) {
                IS_TRIAL = false;
                status = checkKey(lic);
                IS_LICENSED = true;
            }
     ...
     * @param path
     */
    public void createLicense(String name, String email, String authCode, TypeLicense licenseType, Date expiration, String version, String path) {
        byte[] entropy = null;
